...
Requirements:
Unity 2022.3.12f1
Tilt 5 Headset and XE Board - vertically mounted.
Tilt 5 Control Panel
Ultra Leap 2 Hand Tracker.
Ultra Leap Control Panel.
A dark or dimly lit room.

Set Up:
- Mount The Tilt 5 XE Board with the center just under head height hanging on a wall or by clamps on a metal rod.
- Mount the UltraLeap Hand tracker just below the board angled 30 - 45 degrees up towards the player.
...
(application found: C:\Program Files\TiltFive\SDK\Utils\gameboard_transform.exe)
